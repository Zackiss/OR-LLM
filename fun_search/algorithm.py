...
L, W, H = 12, 2.33, 2.39
container_capacity, container_amount = 2400, 1  # currently not used
boxes = [(1.09, 0.5, 0.885)] * 66 + [(1.095, 0.495, 1.48)] * 8 + [(0.915, 0.37, 0.615)] * 80
boxes_weight = [100, 200, 100]  # currently not used
...
if __name__ == "__main__":
    ...
    for i, (l, w, h, _, _, _) in enumerate(failed_box_list):
        print(f"Box {i + len(failed_box_list)} ({l:.2f}x{w:.2f}x{h:.2f}) cannot be placed")
